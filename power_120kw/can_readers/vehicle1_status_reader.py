...
class Vehicle1StatusReader(BaseReader):
    ...
    def read_input_data(self):
        ...
        def startCharging(module_ids):
            ...
            for module_id in module_ids:
                mm.setVoltage(DTH.convertohex(target_volatge_from_car1), module_id)
